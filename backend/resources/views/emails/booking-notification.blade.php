...
<head>
    ...
    <title>Booking Notification - Yoga Retreat</title>
</head>
    ...
    <table width="100%" cellpadding="0" cellspacing="0" style="max-width: 600px; margin: 0 auto; background-color: #ffffff; box-shadow: 0 0 10px rgba(0,0,0,0.1);">
        ...
        <tr>
            <td style="padding: 40px 30px;">
                ...
                @if($status == 'Accepted')
                <p style="margin-bottom: 20px;">We're thrilled to inform that we have confirmed your booking for the following {{$category_name}}. Get ready for a transformative experience that will nourish your body, mind, and soul.</p>
                ...
                @else
                <p style="margin-bottom: 20px;">We're regret to inform that your booking has been declined due to unavailable slot. Please wait until next opening.</p>
                @endif
