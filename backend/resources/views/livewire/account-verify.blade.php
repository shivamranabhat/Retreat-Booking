<!-- confirm section -->
<section
    class="confirm flex flex-col gap-y-36 mt-16 px-6 md:px-28 lg:px-48 xl:px-56 py-14 md:py-20 h-[80vh] md:h-screen justify-center">
    <div class="container mx-auto flex flex-col gap-y-8 w-full md:w-[80%] lg:w-[60%]">
        <div class="title flex flex-col gap-y-2">
            <h2 class="text-4xl font-bold">Confirm Account</h2>
            <p class="text-gray-700">Enter your otp to confirm your account.</p>
        </div>
        <div class="h-px bg-gray-300 mb-4"></div>
        <form class="col-span-2 flex flex-col gap-6" wire:submit='verifyOtp'>
