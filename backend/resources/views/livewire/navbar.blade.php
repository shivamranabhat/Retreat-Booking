        ...
        <div class="links">
            <ul class="hidden lg:flex gap-x-10 items-center">
                ...
                <div
                    ...
                    @if(auth()->user())
                    <span class="text-sm font-semibold text-white lowercase">
                        {{ substr(explode(' ', auth()->user()->name)[0], 0, 3) }}..
                    </span>
                    @else
                    @endif
                    <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" fill="#fff"
                        version="1.1" id="Capa_1" class="w-3 h-3 mt-1" viewBox="0 0 96.154 96.154" xml:space="preserve">
                        <g>
                            <path
