                                ...
                                <div class="right-col grid grid-cols-5 gap-4 col-span-3">
                                    ...
                                    <div class="book-btn col-span-5 md:col-span-2 flex flex-col gap-y-4 lg:gap-y-6">
                                        <div class="upper-col flex flex-col gap-y-2">
                                            ...
                                            <span class="flex gap-1 text-sm text-gray-500">4.5 <svg
                                        ...
                                        <a href="{{route('retreat.review',['slug'=>$inquiry->package->slug])}}"
                                            class="text-sm text-center text-white p-2 rounded-3xl hover:ease-in-out duration-300 transition-all {{$inquiry->package->status == 0 || $inquiry->status !== 'Approved' ? 'bg-gray-400 cursor-not-allowed' : 'bg-main hover:bg-[#03914D]'}}">Write
                                            Review</a>
                                    </div>
                                </div>
                            </div>
