                            ...
                            <form method="POST" action="{{ route('main.update', $content->slug) }}" enctype="multipart/form-data">
                                ...
                                <div class="row">
                                    <div class="d-flex gap-4">
                                        ...
                                        <video id="mediaPlayer" width="150" height="100" controls autoplay>
                                            <source src="{{ asset('storage/' . $content->image) }}" type="video/mp4">
                                            <source src="{{ asset('storage/' . $content->image) }}" type="video/webm">
                                ...
                                <div class="form-outline mb-3">
                                    ...
                                    <textarea class="form-control @error('subtitle') is-invalid @enderror {{ $errors->has('subtitle') ? 'error' : '' }}" id="subtitle" name="subtitle" rows="1">{{ $content->subtitle }}</textarea>
                                </div>
