                ...
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card-body mt-2">
                            <form method="POST" action="{{ route('location.update',$location->slug) }}" enctype="multipart/form-data">
                                @csrf
                                @method('PUT')
                                ...
                                <div class="row align-items-end">
                                    <div class="image-area"><img id="mainImage" src="{{asset('storage/'.$location->image)}}" width="150"></div>
