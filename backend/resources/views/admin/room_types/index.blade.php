                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="flex align-items-center list-user-action">
                                                            ...
                                                            <button type="button" class="btn btn-sm btn-icon btn-danger" data-bs-toggle="modal" data-bs-target="#delete_{{ $roomType->slug }}" title="Delete">
                                                                <span class="btn-inner">
                                                            ...
                                                            <div class="modal fade" id="delete_{{ $roomType->slug }}" tabindex="-1" role="dialog" aria-labelledby="deleteTitle" aria-hidden="true">
