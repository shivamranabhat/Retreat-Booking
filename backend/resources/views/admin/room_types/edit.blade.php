                            ...
                            <form action="{{ route('roomType.update', $roomType->slug) }}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="form-outline mb-4">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6" id="image-preview-area">
                                            <h6>New Image Preview:</h6>
                                            <div class="row"></div> <!-- New image previews will appear here -->
                                        </div>
                                    ...
                                    <input class="form-control mt-3 @error('image') is-invalid @enderror" type="file" id="image" name="image" accept="image/*" />
                                    @error('image')
                                    <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
                                ...
                                <div class="form-outline mb-4">
                                    ...
                                    <input type="number" name="percentage" id="percentage"
                                        ...
                                        value="{{ old('percentage', $roomType->percentage) }}" required />
                                    @error('percentage')
                                    <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
