                                    ...
                                    <table class="table dataTable" aria-describedby="datatable_info">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>{{ $featuredPackage->package->title }}</td>
                                                ...
                                                <td>
                                                    <div class="flex align-items-center list-user-action">
                                                        ...
                                                        <a class="btn btn-sm btn-icon btn-danger" type="button" data-toggle="modal" data-target="#delete_{{ $featuredPackage->slug }}" data-bs-original-title="Delete">
                                                            <span class="btn-inner">
                                                        ...
                                                        <!-- Modal -->
                                                        <div class="modal fade" id="delete_{{ $featuredPackage->slug }}" tabindex="-1" role="dialog"
